// Fields list for the DeviceInternalState object received from the native layer.
import 'package:flutter/foundation.dart';

// These field keys must match with ones declared in java side in DeviceInternalState.java
enum DeviceInternalStateFields {
  ...
  // ble RSSI.
  bleRssi,
  // Boolean array indicating if a channel lead is considered to be off (Impedance too high).
...
class DeviceInternalState {
  ...
  DeviceInternalState(Map<String, dynamic> values) :
        ...
        leadsOffPositive = List<bool>.from(
