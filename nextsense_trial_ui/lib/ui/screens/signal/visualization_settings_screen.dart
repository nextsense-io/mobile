...
import 'package:nextsense_trial_ui/ui/screens/signal/visualization_settings_screen_vm.dart';
import 'package:stacked/stacked.dart';

class VisualizationSettingsScreen extends HookWidget {
  static const String id = 'visualization_settings_screen';

  VisualizationSettingsScreen();
    ...
    return Row(
      children: <Widget>[
        ...
        Expanded(
          flex: 55,
          child: ListTile(
            title: MediumText(text: 'Filtered'),
            leading: Radio(
        ...
        child: ListView(
          ...
          children: <Widget>[
            ...
            Container(
              ...
              child: MediumText(text: "Notch Filter"),
            ),
            DropDownMenu(
