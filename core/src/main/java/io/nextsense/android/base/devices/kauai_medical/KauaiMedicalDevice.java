...
public class KauaiMedicalDevice extends BaseNextSenseDevice implements NextSenseDevice {
  ...
  private static final String TAG = KauaiMedicalDevice.class.getSimpleName();
  ...
  private KauaiMedicalDataParser kauaiMedicalDataParser;
  private KauaiMedicalProtoDataParser kauaiMedicalProtoDataParser;
  ...
  private DeviceInfo deviceInfo = new DeviceInfo(DeviceType.KAUAI_MEDICAL,
  ...
  public KauaiMedicalDevice() {}

  public KauaiMedicalDevice(LocalSessionManager localSessionManager) {
  ...
  public void setLocalSessionManager(LocalSessionManager localSessionManager) {
    ...
    kauaiMedicalDataParser = KauaiMedicalDataParser.create(getLocalSessionManager());
    kauaiMedicalProtoDataParser = KauaiMedicalProtoDataParser.create();
  }
...
//          }
  ...
  public void onKauaiHostMessage(KauaiMedicalHostResponse hostResponse) {
  ...
  @Subscribe(threadMode = ThreadMode.BACKGROUND)
  public void onKauaiHostEvent(KauaiMedicalHostEvent hostEvent) {
  ...
  private boolean verifyIsExpectedResponse(KauaiMedicalHostResponse response) {
  ...
  private void executeCommandNoResponse(KauaiMedicalFirmwareMessage command) throws
  ...
  private void readCommandResponse() throws
    ...
    while (tryNumber < READ_MAX_ATTEMPTS && !readWithSuccess) {
      try {
        ...
        kauaiMedicalProtoDataParser.parseProtoDataBytes(responseBytes);
  ...
  private final BluetoothPeripheralCallback bluetoothPeripheralCallback =
      new BluetoothPeripheralCallback() {
        ...
        public void onCharacteristicUpdate(
          ...
          if (isDataCharacteristic(characteristic)) {
            try {
              kauaiMedicalDataParser.parseDataBytes(value, enabledChannels, null,
            ...
            try {
              ...
              kauaiMedicalProtoDataParser.parseProtoDataBytes(value);
            } catch (FirmwareMessageParsingException e) {
