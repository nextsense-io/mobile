 ...
 */
public class KauaiSampleFlags implements SampleFlags {
  ...
  private KauaiSampleFlags(boolean sync, boolean trigOut, boolean trigIn, boolean zMod, boolean marker,
  ...
  public static KauaiSampleFlags create(byte flagsByte) {
      ...
      return new KauaiSampleFlags(sync, trigOut, trigIn, zMod, marker, tbd6, tbd7, button);
  }

  public static KauaiSampleFlags create(boolean[] flags) {
