...
public class KauaiSampleFlags implements SampleFlags {
  ...
  private KauaiSampleFlags(boolean sync, boolean trigOut, boolean trigIn, boolean tbd4,
  ...
  public static KauaiSampleFlags create(byte flagsByte) {
    ...
    return new KauaiSampleFlags(sync, trigOut, trigIn, tbd4, button, hdmiPresent, tbd7, tbd8);
  }
